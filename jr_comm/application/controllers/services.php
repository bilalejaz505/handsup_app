...
class Services extends CI_Controller
{
    public function __construct()
    {
		...
		$this->load->model('ems/model_service');
    }
 ...
 // about Profile
      //  $data['content'] = $this->model_contents->fetchRow(4);
  //    $data['bannerphotos'] = $this->model_content_images->fetchBannerImages(2);  these images are not in use off this page
       //$data['content_side_image'] = $this->model_content_images->fetchSideImages(4);
		$data['services'] = $this->model_service->fetchAllServices();
	  ...
	  public function service_detail($service_id)
    {
        ...
        $data['servicet_detail'] = $this->model_service->fetch($service_id);// fetch project detail
