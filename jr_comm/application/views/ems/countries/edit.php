...
<div class="inner_left_headingsmalll">Website</div>
              ...
              <div class="inner_mid_heading">Countries - Edit</div>
...
<!--               </div>side_right-->
             ...
             <?php echo form_open_multipart('ems/countries/update/id/'.$res[0]['id'],array('method'=>'post','id'=>'updateAbout'));?>
      ...
      <!--edit_data_table-->
       <div class="edit_data_table">
             ...
             <div class="edit_data_table_row">
               ...
               <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $res[0]['eng_country_name']; ?>" name="eng_country_name" id="eng_country_name"></div>
      ...
      <!--edit_data_table-->
       <div class="edit_data_table">
             ...
             <div class="edit_data_table_row">
               ...
               <div class="edit_data_table_col1"> Title</div>
               <div class="edit_data_table_col2"><input type="text" class="input_field required" name="ar_country_name" id="ar_country_name" value="<?php echo $res[0]['ar_country_name'];?>"></div>
