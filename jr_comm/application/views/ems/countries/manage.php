    ...
    $(document).ready(function() {
            ...
            if($("td.blue_bar" ).length!=0){
                if(confirm('Are you sure to delete this?')) {
                    $( "td.blue_bar" ).each(function() {
                        ...
                        id = parseInt(temp[1]);
                        $('#id_'+id).hide('slow');				 			 	
                        url ='<?php echo base_url(); ?>ems/countries/delete';
        ...
        $('#edit').click( function() {
            ...
            if($("td.blue_bar" ).length != 0)
            {
                ...
                {
                    window.location = '<?php echo base_url(); ?>ems/countries/edit/id/'+id;
                }else{
                    alert("Select any one row from table");	
                }
     ...
     update: function(event, ui) {
            ...
            for(var i=0;i<trs.length;i++)
            {
               example += "&example[]="+trs[i].id;
                    ...
                    var table="example";
                    var ajxFile ="<?php echo base_url();?>ems/countries/sortCol";
...
<div class="content_row">
    ...
    <div class="black_bar_main">
        ...
        <div class="inner_mid_heading">Countries</div>
                        ...
                        foreach ($res as $result => $val) {
                            ...
                            <tr class="odd" id="id_<?php echo $val['id'] ?>" onclick="javascript:highlight(<?php echo $val['id']; ?>);">
                             <!-- <td style="display:none"><?php echo $count; ?></td>-->
                                ...
                                <td class="table_row" ><?php echo $val['eng_country_name'] ?></td>
