            ...
            if ($("td.blue_bar").length != 0) {
                if (confirm('Are you sure to delete this?')) {
                    $("td.blue_bar").each(function () {
                        ...
                        $('#id_' + id).hide('slow');
                        url = '<?php echo base_url(); ?>ems/ctct/deletecampaign';
        ...
        $('#edit').click(function () {
            ...
            if ($("td.blue_bar").length != 0) {
                ...
                if ($("td.blue_bar").length == 1) {
                    window.location = '<?php echo base_url(); ?>ems/ctct/campaignForm/' + id;
                } else {
                    alert("Select any one row from table");
                }
            } else {
...
<!--<div class="search_button"><img src="images/search_button.png" width="36" height="32" /></div>-->
    ...
    <div class="middle_content_areainner" style="padding-top:0px;">
      ...
      <li><a href="ems/ctct/campaignForm">Send New Email</a></li>
...
-->      <li><a id="delete">Delete</a></li>
        ...
        <div class="admin_manage_panel" style="padding-top:20px;">
            ...
            <h3 style="padding:10px;">Emails History:</h3>
                ...
                <table width="100%"   border="0" class="display table_style_gray2" id="example">
                    <thead>
                        <tr class="top_row">
                            ...
                            <td  class="text_table_space">Name</td>
                            <td  class="text_table_space">Status</td>
                            <td  class="text_table_space">Date</td>
                  ...
                  <!--  <th><input type="hidden"></th>-->
                    ...
                    <tbody>
                        ...
                        $i = 0;
                        foreach ($campaign_list->results as $result => $val) {
                            ?>
             ...
             <td><?php echo date('d-M-y',strtotime($val->modified_date)); ?></td>                       
                            </tr>
                            <?php
