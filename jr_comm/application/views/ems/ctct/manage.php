            ...
            if ($("td.blue_bar").length != 0) {
                if (confirm('Are you sure to delete this?')) {
                    $("td.blue_bar").each(function () {
                        ...
                        $('#id_' + id).hide('slow');
                        url = '<?php echo base_url(); ?>ems/ctct/deletecontact';
        ...
        $('#edit').click(function () {
            ...
            if ($("td.blue_bar").length != 0) {
                ...
                if ($("td.blue_bar").length == 1) {
                    window.location = '<?php echo base_url(); ?>ems/ctct/contactForm/' + id;
                } else {
                    alert("Select any one row from table");
                }
            } else {
...
<!--<div class="search_button"><img src="images/search_button.png" width="36" height="32" /></div>-->
    ...
    <div class="middle_content_areainner" style="padding-top:0px;">
      ...
      <li><a href="ems/ctct/campaign">Email</a></li>
      <li><a href="ems/ctct/contactForm">Add Contact</a></li>
      ...
      <li><a id="delete">Delete</a></li>
        ...
        <div class="admin_manage_panel" style="padding-top: 23px;">
        
        <ul style="list-style: square; margin-left: 30px" class="instruction">
        <li style="cursor: auto;" ><strong>Instructions</strong></li>

<li style="cursor: auto;"> Buy a constantcontact.com account</li>

<li style="cursor: auto;" > Ask eDesign support to make a new application for you at <a href="http://constantcontact.mashery.com" target="_blank">constantcontact.mashery.com</a></li>

<li style="cursor: auto;" >eDesign support will login with its developer account and will create a new application.</li>

<li style="cursor: auto;" >Then eDesign will generate a <strong>"ACCESS_TOKEN"</strong>. It will ask for the live constant contact account login while generating the "Key".</li>

<li style="cursor: auto;" >Copy the <strong>"Key"</strong> and <strong>"ACCESS_TOKEN"</strong> and put it in backend CMS. This will attach the backend CMS with client constant contact.</li>

<li style="cursor: auto;" >Then client needs to create a list in the constant contact and the created lists will show in the backend CMS.</li>

<li style="cursor: auto;" >There will be an option to select one list to attach with the frontend.</li>
</ul>
            <h3 style="padding:10px;margin-left:10px;">Following are subscribed members:</h3>
                ...
                <table width="100%"   border="0" class="display table_style_gray2" id="example">
                    <thead>
                        <tr class="top_row">
                            ...
                            <!--<td width="70%" class="text_table_space">Name</td>-->
                            <td width="70%" class="text_table_space">Email</td>
<td width="30%" class="text_table_space"></td>
                        </tr>
                    </thead>
                    <tfoot>
                  <!--  <th><input type="hidden"></th>-->
                    ...
                    <tbody>
                        ...
                        $i = 0;
                        foreach ($contact_list->results as $result => $val) {
						if($val->status == 'ACTIVE'){
                            ...
                            <!--  <td style="display:none"><?php echo $i; ?></td>-->
                               ...
                               <!-- <td class="table_row"><?php echo $val->first_name.' '.$val->last_name; ?></td> -->                                
                                  
                                   <td class="table_row"><?php echo $val->email_addresses[0]->email_address; ?></td>
