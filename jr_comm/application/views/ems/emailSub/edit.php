...
<div class="inner_left_headingsmalll">Website</div>
              ...
              <div class="inner_mid_heading">Email Subject - Edit</div>
               ...
               <div class="side_right">
                 ...
                 <div class="seprator_horizontal"></div>
                     ...
                     <div class="previewChangesBtn"> 
                         <a target="_blank" href="<?php echo base_url()."reachus";?>"><img src="assets/images/previewChanges.png" width="108" height="23" border="0" alt=""/> </a>
                     </div>
                                     
                                     <div class="modifiedDate">Last modified <?php echo formatModifiedDate($res->sub_updated_at);?> </div>
                                     
                                     
                                     </div>
                 <!-- status bar - start-->   
                 <?php $pub = $res->sub_pub_status;?>
             ...
             <?php echo form_open_multipart('ems/emailSub/update/id/'.$res->id,array('method'=>'post','id'=>'currentForm'));?>
                   <input type="hidden" value="<?php echo $res->sub_pub_status?>" id="pub_val" name="pub_val">
      ...
      <!--edit_data_table-->
       <div class="edit_data_table">
             ...
             <div class="edit_data_table_row">
               ...
               <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $res->eng_sub_title; ?>" name="eng_sub_title"></div>
      ...
      <!--edit_data_table-->
       <div class="edit_data_table">
             ...
             <div class="edit_data_table_row">
               ...
               <div class="edit_data_table_col1"> Subject</div>
               <div class="edit_data_table_col2"><input type="text" class="input_field required" name="arb_sub_title" value="<?php echo $res->arb_sub_title?>"></div>
             ...
             <div class="edit_data_table_row">
              ...
              <p style="margin-left: 150px;margin-top: 113px;">Enter tags separated with comma, Example: dogs, "anygry birds",cats</p>
                           ...
                           <div class="table_content_row">
                               ...
                               <table width="100%" border="0" class="edit_table" style="margin-top: 20px;">
	  <tbody>
      ...
      <!--edit_data_table-->
       <div class="edit_data_table">
             ...
             <div class="edit_data_table_row">
               ...
               <div class="edit_data_table_col1"> Subject</div>
               <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $res->chn_sub_title?>" name="chn_sub_title"></div>
             
             
             </div>
           <div class="edit_data_table_row">
            <div class="edit_data_table_col1"> Meta Title</div>
               <div class="edit_data_table_col2"><input type="text" class="input_field "  value="<?php echo $res->meta_title_chn; ?>" name="meta_title_chn" id="meta_title_chn"></div>
             </div>
