	 ...
	 $('#published').change(function(event){
            ...
            if($("td.blue_bar" ).length!=0){
                if(confirm('Are you sure to delete this?')) {
                    $( "td.blue_bar" ).each(function() {
                        ...
                        id = parseInt(temp[1]);
                        $('#id_'+id).hide('slow');				 			 	
                        url ='<?php echo base_url(); ?>ems/emailSub/delete';
        ...
        $('#edit').click( function() {
            ...
            if($("td.blue_bar" ).length != 0)
            {
                ...
                {
                    window.location = '<?php echo base_url(); ?>ems/emailSub/edit/id/'+id;
                }else{
                    alert("Select any one row from table");	
                }
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.PageSize').click(function(){$('#example').tableDnDUpdate()});
//    prettyPrint();
        ...
        $('#example').tableDnD({
            onDrop: function(table, row) {
                ...
                //alert(decodeURI($.tableDnD.serialize()));
//            $('#AjaxResult').load("server/ajaxTest.php?" + $.tableDnD.serialize());
                var url = 'ems/emailSub/sortCol?' + decodeURI($.tableDnD.serialize());
...
<div class="inner_left_headingsmalll">Website</div>
              ...
              <div class="inner_mid_heading">Email Subjects</div>
                 ...
                 <div class="previewChangespanel"> 
                     ...
                     <div class="previewChangesBtn"> 
                         <a target="_blank" href="<?php echo base_url()."reachus";?>"><img src="assets/images/previewChanges.png" width="108" height="23" border="0" alt=""/> </a>
                                     ...
                                     <div class="modifiedDate">Last modified <?php echo fetchLastupdated("email_subjects","sub_updated_at");?> </div>
    ...
    width: 100% !important;">
                   ...
                   <div class="dropdownRow">
                       ...
                       <div class="dropdownfiled">
                         ...
                         <select name="area" id="area" class="dropDownList"   > 
...
<span><img src="assets/images/black_bar.png"></span>
                ...
                <td width="84%" class="text_table_space">Email Subject</td>
        	...
        	?>
                ...
                <!-- <td style="display:none"><?php echo $count; ?></td>-->
                   <td class="black_bar" id="bar_<?php echo $val['id'] ?>"><?php echo $count; ?></td>
                    <td class="table_row" ><?php echo $val['eng_sub_title']?></td>
                     <td  class="table_row"  style="border-right:#000 0px solid">
                     <?php echo get_grid_status($val['id'],$val['sub_pub_status']);?>
                     </td>                     
