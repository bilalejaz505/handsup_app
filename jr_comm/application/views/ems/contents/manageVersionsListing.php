            ...
            if ($("td.blue_bar").length != 0) {
                if (confirm('Are you sure to delete this?')) {
                    $("td.blue_bar").each(function () {
                        ...
                        $('#id_' + id).hide('slow');
                        url = '<?php echo base_url(); ?>ems/list_content/delete';
        ...
        $('#edit').click(function () {
            ...
            if ($("td.blue_bar").length != 0) {
                ...
                if ($("td.blue_bar").length == 1) {
                    window.location = '<?php echo base_url(); ?>ems/list_content/edit/id/' + page_id + '/version_id/'+ id;
                } else {
                    alert("Select any one row from table");
                }
            } else {
                ...
                <table width="100%"   border="0" class="display table_style_gray2" id="example">
                    <thead>
                        <tr class="top_row">
					        ...
					        <td width="10%" class="text_table_space">Version</td>
                            <td width="50%" class="text_table_space">Pages Tilte</td>
                            
                             <td width="20%" class="text_table_space">Date/Time</td>
                             <td width="20%" class="text_table_space">Created By</td>
                        </tr>
                    </thead>
                    <tfoot>
                    ...
                    <tbody>
                        ...
                        foreach ($versions as $result => $val) {
                            ...
                            <tr class="odd" id="id_<?php echo $val->id; ?>" onclick="javascript:highlight(<?php echo $val->id; ?>);">
                                ...
                                <td class="table_row"><?php echo $i; ?></td> 
                                <td class="table_row"><?php echo $val->eng_title; ?></td> 
                                <td class="table_row"><?php echo $val->content_updated_at; ?></td>
                                <td class="table_row"><?php echo $user_info->usr_uname; ?></td>                               
