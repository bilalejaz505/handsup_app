    ...
    $(document).ready(function () {
        ...
        $('#delete').click(function () {
		   ...
		   $('#trash').click(function () {
            if ($("td.blue_bar").length != 0) {
                if (confirm('Are you sure to trash this?')) {
                    $("td.blue_bar").each(function () {
                        var temp = $(this).attr('id').split('_');
                        var id = parseInt(temp[1]);
                        $('#id_' + id).hide('slow');
                        url = '<?php echo base_url(); ?>ems/content/trash';
                        $.post(url, {id: id,move_to_trash: 1}, function (data) {
                            $("#example").dataTable().fnDraw(true);
                        });
                    });
                }
        ...
        $('#edit').click(function () {
            ...
            if ($("td.blue_bar").length != 0) {
                ...
                if ($("td.blue_bar").length == 1) {
                    window.location = '<?php echo base_url(); ?>ems/content/edit/id/' + id;
                } else {
                    alert("Select any one row from table");
                }
            } else {
...
<div class="content_row">
    ...
    <div class="black_bar_main">
        ...
        <div class="inner_mid_heading">Manage Pages </div>
...
<!--<div class="search_button"><img src="images/search_button.png" width="36" height="32" /></div>-->
    ...
    <div class="middle_content_areainner" style="padding-top:0px;">
        ...
        <div class="inner_menu_bar">
            ...
            <ul>
				<li><a class="page_order">Ordering</a></li>
               <li><a href="<?php echo base_url();?>ems/content/addNewPage">Add</a></li>
               <li><a href="<?php echo base_url();?>ems/content/trashPages">Trash Pages</a></li>
               <li ><a id="edit">Edit</a></li>
                <li><a id="trash">Move to Trash</a></li>
                ...
                <table width="100%"   border="0" class="display table_style_gray2" id="example">
                    <thead>
                        <tr class="top_row">
                            ...
                            <td width="1%" style="padding-top:0"><p id="enable"><a onclick="javascript:enable(<?php echo $clientList[0]->id; ?>);">
                                        <span><img src="assets/images/black_bar.png"></span>
                                    </a></p><p id="disable" style="display:none"><a onclick="javascript:disable();">
                                        <span><img src="assets/images/black_bar.png"></span>
                                    </a></p></td>

                            <td width="70%" class="text_table_space">Pages Tilte</td>
                            <td width="10%" class="text_table_space"></td>
                        </tr>
                    </thead>
                    <tfoot>
                    ...
                    <tbody id="sortme">
                        ...
                        foreach ($pages as $result => $val) {
                            ...
                            <!--  <td style="display:none"><?php echo $i; ?></td>-->
                                ...
                                <td class="table_row"><?php echo $val->eng_title; ?></td>                                
