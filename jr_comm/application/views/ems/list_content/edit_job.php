        ...
        <div class="inner_menu_bar" style="width:22%;">
            ...
            <ul>
               ...
               <!-- <li style="z-index:99; width:53%;"><a href="" id="submit" name="submit" >Save</a></li>-->
                ...
                <li style="z-index:100; left:45%; width:100%;"><a onclick="javascript:history.back();">Back</a></li>
                                    ...
                                    <div class="edit_data_table">
									 ...
									 <!-- <div class="edit_data_table_row">
                                        ...
                                        <div class="edit_data_table_row">
                                            ...
                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $jobs->first_name;?>" name="first_name" id="eng_slide_title" disabled></div>
                                        ...
                                        <div class="edit_data_table_row">
                                            ...
                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $jobs->last_name;?>" name="last_name" id="last_name" disabled></div>

                                        </div>
										<div class="edit_data_table_row">

                                            <div class="edit_data_table_col1">Gender</div>

                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $jobs->gender;?>" name="gender" id="eng_slide_title" disabled></div>
										...
										<div class="edit_data_table_row">
                                            ...
                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $jobs->dob;?>" name="dob" id="dob" disabled></div>

                                        </div>
										<div class="edit_data_table_row">

                                            <div class="edit_data_table_col1">Telephone No.</div>

                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $jobs->tel_phone;?>" name="tel_phone" id="tel_phone" disabled></div>
                                        ...
                                        <div class="edit_data_table_row">
                                            ...
                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $jobs->country; ?>" name="country" id="country" disabled></div>
                                       ...
                                       <div class="edit_data_table_row">
                                            ...
                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php echo $jobs->city; ?>" name="country" id="country"disabled></div>
                                      ...
                                      <!--  <div class="edit_data_table_row">
                                            ...
                                            <div class="edit_data_table_col2"><input type="text" class="input_field required"  value="<?php //echo $jobs->email; ?>" name="email"></div>
                                                                ...
                                                                <!--<div class="user_pic_wrap_<?php echo $image->id; ?>">-->
                                                                    ...
                                                                    if ($ext != '') {
                                                                        if($ext == 'jpg' || $ext == 'jpeg' || $ext == 'png' || $ext == 'gif'){
                                                                            echo '<img src="uploads/cv/'.$jobs->cv.'" target = "_blank" width="112px" height="108px">';
                                                                        }else{
                                                                            echo 'Click <a href="uploads/cv/'.$jobs->cv.'" target = "_blank" >here</a> to download file';
                                                                        }
                                                                    } else {
