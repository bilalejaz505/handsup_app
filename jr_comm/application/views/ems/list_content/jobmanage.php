            ...
            if ($("td.blue_bar").length != 0) {
                if (confirm('Are you sure to delete this?')) {
                    $("td.blue_bar").each(function () {
                        ...
                        $('#id_' + id).hide('slow');
                        url = '<?php echo base_url(); ?>ems/list_content/deleteJob';
        ...
        $('#edit').click(function () {
            ...
            if ($("td.blue_bar").length != 0) {
                ...
                if ($("td.blue_bar").length == 1) {
                    window.location = '<?php echo base_url(); ?>ems/list_content/jobEdit/id/' + id;
                } else {
                    alert("Select any one row from table");
                }
            } else {
...
<div class="content_row">
    ...
    <div class="black_bar_main">
        ...
        <div class="inner_mid_heading">Job Applications</div>
                ...
                <table width="100%"   border="0" class="display table_style_gray2" id="example">
                  ...
                  <!--  <th><input type="hidden"></th>-->
                    ...
                    <tbody>
                        <?php
                        $i = 0;
                        foreach ($all_jobs as $result => $val) {
                            ?>
                            ...
                            <!--  <td style="display:none"><?php echo $i; ?></td>-->
                                ...
                                <td class="table_row"><?php echo $val->first_name;?></td>                                
