		...
		$('#apply').click(function () {
            ...
            if ($("td.blue_bar").length != 0) {
                ...
                if ($("td.blue_bar").length == 1) {
                    ...
                    window.location = '<?php echo base_url(); ?>ems/list_content/jobManage/id/' + id;
                } else {
                    alert("Select any one row from table");
                }
            } else {
        ...
        $('#edit').click(function () {
            ...
            if ($("td.blue_bar").length != 0) {
                ...
                if ($("td.blue_bar").length == 1) {
                    ...
                    window.location = '<?php echo base_url(); ?>ems/list_content/edit/id/' + id;
                } else {
                    alert("Select any one row from table");
                }
            } else {
...
function goBack(){
		var back_page = '<?php echo base_url(); ?>ems/content/edit/id/' + currentPageID;
		if(backPages.length > 0){
			back_page = '<?php echo base_url(); ?>ems/list_content/edit/id/' + currentPageID;
		}
...
<div class="content_row">
    ...
    <div class="black_bar_main">
        ...
        <div class="inner_mid_heading">Manage Content</div>
    ...
    <div class="middle_content_areainner" style="padding-top:0px;">
        ...
        <div class="inner_menu_bar">
            ...
            <ul>
				...
				{  ?>
				 <li style="z-index:300; left:75%"><a   id="apply">Job Applicants</a></li>
				<?php } ?>
                <?php echo top_navigation(); ?>
                <li style="z-index:300; left:75%"><a  id="back" href="javascript:void(0);" onclick="goBack();">Back</a></li>
                ...
                <table width="100%"   border="0" class="display table_style_gray2" id="example">
                    <thead>
                        ...
                        <tr class="top_row">
                            ...
                            <td width="70%" class="text_table_space">Title</td>
                            <td width="10%" class="text_table_space">Active</td>
                        </tr>
                    </thead>
                    <tfoot>
