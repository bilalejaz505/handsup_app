	 ...
	 $('#published').change(function(event){
            ...
            if($("td.blue_bar" ).length!=0){
                if(confirm('Are you sure to delete this?')) {
                    $( "td.blue_bar" ).each(function() {
                        ...
                        id = parseInt(temp[1]);
                        $('#id_'+id).hide('slow');				 			 	
                        url ='<?php echo base_url(); ?>ems/inquries/delete';
        ...
        $('#edit').click( function() {
            ...
            if($("td.blue_bar" ).length != 0)
            {
                ...
                {
                    window.location = '<?php echo base_url(); ?>ems/inquries/view/id/'+id;
                }else{
                    alert("Select any one row from table");	
                }
        ...
        $('input[id ^="inq_pub_status_"]').click(function(){
        	  var id = this.id.replace('inq_pub_status_','');
                  //alert(id);
				if ($('#inq_pub_status_'+id).is(":checked"))
				{
					publishStatus=1;
				}
				else
        	  ...
        	  url ='<?php echo base_url(); ?>ems/inquries/publish';
...
<div class="inner_left_headingsmalll">Website</div>
              ...
              <div class="inner_mid_heading">Inquiries</div>
             ...
             <div class="inner_gray_panel" >
               ...
               <div class="side_right">
                 ...
                 <div class="previewChangespanel"> 
                                     ...
                                     <div class="modifiedDate">Last modified <?php echo fetchLastupdated("inquries","inq_updated_at");?> </div>
...
to filter the grid</div>
    ...
    width: 100% !important;">
                   ...
                   <div class="filter_heading">Filters</div>
                     ...
                     <ul>
					 <!--<li style="z-index:300; left:50%"><a id="quotes" href="ems/inquries/manageQuotes">Manage Quotes</a></li> -->
                           <li style="z-index:300; left:50%"><a id="delete">Delete</a></li>
						  <li style="z-index:300; left:50%"><a id="edit">View</a></li>
...
<span><img src="assets/images/black_bar.png"></span>
                ...
                <td width="40%" class="text_table_space">Name</td>
                <td width="40%" class="text_table_space">Email</td>
                <td width="20%" class="text_table_space">Read / Un-read</td>
            </tr>
        </thead>
         <tfoot>
                ...
                <tr class="odd" id="id_<?php echo $val['id'] ?>" onclick="javascript:highlight(<?php echo $val['id'];?>);">
                 <!-- <td style="display:none"><?php echo $count; ?></td>-->
                   <td class="black_bar" id="bar_<?php echo $val['id'] ?>"><?php echo $count; ?></td>
                    <td class="table_row" ><?php echo $val['inq_user']?></td>
                    <td class="table_row" ><?php echo $val['inq_email']?></td>
                     <td class="table_row"  style="border-right:#000 0px solid">
					<div style="float:left; opacity:0;filter:alpha(opacity=0)"><?php echo $val['inq_pub_status']?></div><div class="squaredOne"><input type="checkbox" name="inq_pub_status" id="inq_pub_status_<?php echo $val['id'] ?>" <?php if($val['inq_pub_status']==1){echo "checked=checked";}?>><label for="inq_pub_status_<?php echo $val['id'] ?>"></label></div></td>
