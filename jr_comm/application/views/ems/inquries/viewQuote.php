...
<div class="inner_gray_panel" >
    ...
    <div class="middle_content_areainner" style="padding-top:0px;">
        ...
        <div class="inner_menu_bar" style="width:22%;">
            ...
            <ul>
                <li style="z-index:100; left:45%;"><a href="ems/inquries/manageQuotes">Back</a></li>
                        ...
                        <td>
                            ...
                            <div class="edit_data_table">
                                ...
                                <div class="edit_data_table_row">
                                    ...
                                    <div class="edit_data_table_col2"><input type="text" class="input_field required" value="<?php echo $res->name; ?>" name="eng_name" disabled></div>
                                ...
                                <div class="edit_data_table_row">
                                    ...
                                    <div class="edit_data_table_col2">
                                        ...
                                        <input type="text" class="input_field required email" value="<?php echo $res->email; ?>" name="email" id="email" disabled>
                                    </div>
                                ...
                                <div class="edit_data_table_row">
                                    ...
                                    <div class="edit_data_table_col2"><input type="text" class="input_field required" name="phone" id="phone" value="<?php echo $res->phone; ?>" disabled></div>
                                ...
                                <div class="edit_data_table_row">
                                    ...
                                    <div class="edit_data_table_col1"> Category</div>
                                    <div class="edit_data_table_col2"><input type="text" class="input_field required" name="phone" id="phone" value="<?php echo pageTitle($res->category, eng); ?>" disabled></div>
                                ...
                                <div class="edit_data_table_row">
                                    ...
                                    <div class="edit_data_table_col1"> Sub Category</div>
                                    <div class="edit_data_table_col2"><input type="text" class="input_field required" name="phone" id="phone" value="<?php echo pageTitle($res->sub_category, eng); ?>" disabled></div>
                                ...
                                <div class="edit_data_table_row">
                                    ...
                                    <div class="edit_data_table_col1"> Sub Sub Category</div>
                                    <div class="edit_data_table_col2"><input type="text" class="input_field required" name="phone" id="phone" value="<?php echo pageTitle($res->sub_sub_category, eng); ?>" disabled></div>

                                </div>

                                <div class="edit_data_table_row">

                                    <div class="edit_data_table_col1"> Product</div>
                                    <div class="edit_data_table_col2"><input type="text" class="input_field required" name="phone" id="phone" value="<?php echo pageTitle($res->product, eng); ?>" disabled></div>
                                ...
                                <div class="edit_data_table_row">
                                    ...
                                    <div class="edit_data_table_col2"><textarea name="description" disabled id="eng_description" rows="10" cols="55"><?php echo $res->message; ?></textarea><?php echo display_ckeditor($ckeditor); ?></div>
