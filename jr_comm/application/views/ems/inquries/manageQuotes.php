	 ...
	 $('#published').change(function(event){
            ...
            if($("td.blue_bar" ).length!=0){
                if(confirm('Are you sure to delete this?')) {
                    $( "td.blue_bar" ).each(function() {
                        ...
                        id = parseInt(temp[1]);
                        $('#id_'+id).hide('slow');				 			 	
                        url ='<?php echo base_url(); ?>ems/inquries/deleteQuote';
        ...
        $('#edit').click( function() {
            ...
            if($("td.blue_bar" ).length != 0)
            {
                ...
                {
                    window.location = '<?php echo base_url(); ?>ems/inquries/viewQuote/id/'+id;
                }else{
                    alert("Select any one row from table");	
                }
    ...
    width: 100% !important;">
                   ...
                   <div class="filter_heading">Filters</div>
                     ...
                     <ul>
                          ...
                          <li style="z-index:300; left:75%"><a href="javascript:history.back();" id="back" >Back</a></li>
                     </ul>
...
<span><img src="assets/images/black_bar.png"></span>
                ...
                <td width="50%" class="text_table_space">Name</td>
                <td width="50%" class="text_table_space">Email</td>
                ...
                <tr class="odd" id="id_<?php echo $val['id'] ?>" onclick="javascript:highlight(<?php echo $val['id'];?>);">
                 <!-- <td style="display:none"><?php echo $count; ?></td>-->
                   <td class="black_bar" id="bar_<?php echo $val['id'] ?>"><?php echo $count; ?></td>
                    ...
                    <td class="table_row" ><?php echo $val['email']?></td>
