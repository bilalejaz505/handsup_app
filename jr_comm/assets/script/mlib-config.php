...
define('MLIBURL', $config['base_url'].'assets/script/');
...
$mlib_db = new mysqli($db['default']['hostname'], $db['default']['username'], $db['default']['password'], $db['default']['database']);
...
return 'mlib-uploads/thumbs/'.$query.'___'.$thumb;
} else {
