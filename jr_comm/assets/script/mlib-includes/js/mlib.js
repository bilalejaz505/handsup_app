...
//01/22/2016 by Astute
if(i < $(".mlib-selected-thumb").length-1 )
xurl += ",";
...
xstr = xstr+'<div mlib-size="'+xdata[i].size+'" mlib-id="'+xdata[i].id+'" mlib-type="'+xdata[i].type+'" mlib-time="'+xdata[i].newtime+'" mlib-title="'+xdata[i].title+'" mlib-caption="'+xdata[i].caption+'" mlib-url="'+mlib_domain+''+xdata[i].url+'" mlib-thumb="'+mlib_domain+''+xdata[i].thumb+'" class="mlib-thumbs" style="background-image:url(\''+mlib_domain+''+xdata[i].url+'\')">\
